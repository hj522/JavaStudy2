...
public class T04ThreadTest {
		...
		/*
		 	...
		 	전체 합계를 구하는 작업을 단독으로 했을 때(1개의 스레드로 사용했을 때)와
		 	여러 스레드로 분할해서 작업할 때의 시간을 비교해 보자~~
		 */
	...
	public static void main(String[] args) {
		...
		System.out.println("스레드 1개로 처리할 때의 처리 시간(ms): " + (endTime - startTime));
		...
		System.out.println("협력(스레드 4개) 처리했을 때의 처리 시간(ms): "
						    + (endTime - startTime));
	}
}
