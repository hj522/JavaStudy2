...
public class URLConnectionTest {
	public static void main(String[] args) throws IOException {
		...
		// 전체 Header 정보 출력하기
		Map<String, List<String>> headerMap = urlConn.getHeaderFields(); //맵으로 리턴
		
		// Header의 key값 구하기
		Iterator<String> iterator = headerMap.keySet().iterator(); //향상된 for문 방법 이용해도 ㄱㅏ능 
		...
		// 내용 출력하기
		String str = "";
		while((str = br.readLine()) != null) {  //널이 아닐때까지 한줄씩 읽어오기
